...
final traduccionesProvider = Provider<Map<String, Map<String, String>>>((ref) {
  return {
    'Español': {
      ...
      'home_sub': 'Deslizá desde la izquierda o tocá el menú para navegar.',
      'menu_home': 'Inicio',
      'menu_perfil': 'Perfil',
      ...
      'set_idioma_sub': 'Seleccioná el idioma de la interfaz',
      'set_moneda': 'Moneda del precio',
      'set_moneda_sub': 'Precios de frascos y decants',
      'set_vista': 'Visualización del catálogo',
      ...
      'set_btn_volver': 'Volver al inicio',
      ...
      'dialog_cancel_content':
          'Si cancelás, se pierden los cambios que no hayas guardado.',
    ...
    'Português': {
      ...
      'set_btn_volver': 'Voltar para o início',
      'perfil_titulo': 'Perfil de usuário',
      'perfil_guardar': 'Salvar alterações',
      'perfil_cancelar': 'Cancelar',
      'perfil_exito': 'Alterações salvas com sucesso!',
