...
class _FormPerfumeScreenState extends ConsumerState<FormPerfumeScreen> {
  ...
  void _guardarFormulario() async {
    ...
    if (esEdicion) {
      await repo.actualizarPerfume(perfumeFinal, widget.nombreUsuario);
    } else {
      await repo.registrarPerfume(perfumeFinal, widget.nombreUsuario);
    }
        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              _buildInput(_disenador, 'Diseñador', Icons.business),
              _buildInput(
                _precio,
                'Precio (USD)',
                Icons.attach_money,
