...
import 'package:app_perfumes/presentation/viewmodels/opinion_view_model.dart';
...
class _DetailScreenState extends ConsumerState<DetailScreen> {
  ...
  Future<void> _eliminarOpinion(Opinion opinion) async {
    ...
    await ref.read(opinionViewModelProvider).eliminarOpinion(opinion.id!);
    ref.invalidate(opinionesProvider(perfumeId));
  }
